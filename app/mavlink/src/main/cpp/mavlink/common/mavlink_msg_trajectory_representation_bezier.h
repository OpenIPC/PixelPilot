...
mavlink_msg_trajectory_representation_bezier_pack(uint8_t system_id, uint8_t component_id,
                                                  mavlink_message_t *msg,
                                                  uint64_t time_usec, uint8_t valid_points,
                                                  const float *pos_x, const float *pos_y,
                                                  const float *pos_z, const float *delta,
                                                  const float *pos_yaw) {
 ...
 */
static inline uint16_t
mavlink_msg_trajectory_representation_bezier_pack_chan(uint8_t system_id, uint8_t component_id,
                                                       uint8_t chan,
                                                       mavlink_message_t *msg,
                                                       uint64_t time_usec, uint8_t valid_points,
                                                       const float *pos_x, const float *pos_y,
 ...
 */
static inline uint16_t
mavlink_msg_trajectory_representation_bezier_encode(uint8_t system_id, uint8_t component_id,
                                                    mavlink_message_t *msg,
                                                    const mavlink_trajectory_representation_bezier_t *trajectory_representation_bezier) {
    return mavlink_msg_trajectory_representation_bezier_pack(system_id, component_id, msg,
                                                             trajectory_representation_bezier->time_usec,
                                                             trajectory_representation_bezier->valid_points,
                                                             trajectory_representation_bezier->pos_x,
                                                             trajectory_representation_bezier->pos_y,
                                                             trajectory_representation_bezier->pos_z,
                                                             trajectory_representation_bezier->delta,
 ...
 */
static inline uint16_t
mavlink_msg_trajectory_representation_bezier_encode_chan(uint8_t system_id, uint8_t component_id,
                                                         uint8_t chan, mavlink_message_t *msg,
                                                         const mavlink_trajectory_representation_bezier_t *trajectory_representation_bezier) {
    return mavlink_msg_trajectory_representation_bezier_pack_chan(system_id, component_id, chan,
                                                                  msg,
                                                                  trajectory_representation_bezier->time_usec,
                                                                  trajectory_representation_bezier->valid_points,
                                                                  trajectory_representation_bezier->pos_x,
...
mavlink_msg_trajectory_representation_bezier_get_time_usec(const mavlink_message_t *msg) {
...
mavlink_msg_trajectory_representation_bezier_get_valid_points(const mavlink_message_t *msg) {
 ...
 */
static inline uint16_t
mavlink_msg_trajectory_representation_bezier_get_pos_x(const mavlink_message_t *msg, float *pos_x) {
 ...
 */
static inline uint16_t
mavlink_msg_trajectory_representation_bezier_get_pos_y(const mavlink_message_t *msg, float *pos_y) {
 ...
 */
static inline uint16_t
mavlink_msg_trajectory_representation_bezier_get_pos_z(const mavlink_message_t *msg, float *pos_z) {
 ...
 */
static inline uint16_t
mavlink_msg_trajectory_representation_bezier_get_delta(const mavlink_message_t *msg, float *delta) {
 ...
 */
static inline uint16_t
mavlink_msg_trajectory_representation_bezier_get_pos_yaw(const mavlink_message_t *msg,
                                                         float *pos_yaw) {
 ...
 */
static inline void mavlink_msg_trajectory_representation_bezier_decode(const mavlink_message_t *msg,
                                                                       mavlink_trajectory_representation_bezier_t *trajectory_representation_bezier) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
    uint8_t len = msg->len < MAVLINK_MSG_ID_TRAJECTORY_REPRESENTATION_BEZIER_LEN ? msg->len
                                                                                 : MAVLINK_MSG_ID_TRAJECTORY_REPRESENTATION_BEZIER_LEN;
    memset(trajectory_representation_bezier, 0,
           MAVLINK_MSG_ID_TRAJECTORY_REPRESENTATION_BEZIER_LEN);
