...
mavlink_msg_global_vision_position_estimate_pack(uint8_t system_id, uint8_t component_id,
    ...
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), &packet,
           MAVLINK_MSG_ID_GLOBAL_VISION_POSITION_ESTIMATE_LEN);
#endif

    msg->msgid = MAVLINK_MSG_ID_GLOBAL_VISION_POSITION_ESTIMATE;
    return mavlink_finalize_message(msg, system_id, component_id,
                                    MAVLINK_MSG_ID_GLOBAL_VISION_POSITION_ESTIMATE_MIN_LEN,
                                    MAVLINK_MSG_ID_GLOBAL_VISION_POSITION_ESTIMATE_LEN,
                                    MAVLINK_MSG_ID_GLOBAL_VISION_POSITION_ESTIMATE_CRC);
}
 ...
 */
static inline uint16_t
mavlink_msg_global_vision_position_estimate_pack_chan(uint8_t system_id, uint8_t component_id,
                                                      uint8_t chan,
                                                      mavlink_message_t *msg,
                                                      uint64_t usec, float x, float y, float z,
                                                      float roll, float pitch, float yaw,
 ...
 */
static inline uint16_t
mavlink_msg_global_vision_position_estimate_encode(uint8_t system_id, uint8_t component_id,
                                                   mavlink_message_t *msg,
                                                   const mavlink_global_vision_position_estimate_t *global_vision_position_estimate) {
    return mavlink_msg_global_vision_position_estimate_pack(system_id, component_id, msg,
                                                            ...
                                                            global_vision_position_estimate->covariance);
}
 ...
 */
static inline uint16_t
mavlink_msg_global_vision_position_estimate_encode_chan(uint8_t system_id, uint8_t component_id,
                                                        uint8_t chan, mavlink_message_t *msg,
                                                        const mavlink_global_vision_position_estimate_t *global_vision_position_estimate) {
    return mavlink_msg_global_vision_position_estimate_pack_chan(system_id, component_id, chan, msg,
                                                                 global_vision_position_estimate->usec,
                                                                 global_vision_position_estimate->x,
                                                                 global_vision_position_estimate->y,
                                                                 global_vision_position_estimate->z,
...
mavlink_msg_global_vision_position_estimate_get_usec(const mavlink_message_t *msg) {
 ...
 */
static inline float
mavlink_msg_global_vision_position_estimate_get_x(const mavlink_message_t *msg) {
 ...
 */
static inline float
mavlink_msg_global_vision_position_estimate_get_y(const mavlink_message_t *msg) {
 ...
 */
static inline float
mavlink_msg_global_vision_position_estimate_get_z(const mavlink_message_t *msg) {
 ...
 */
static inline float
mavlink_msg_global_vision_position_estimate_get_roll(const mavlink_message_t *msg) {
 ...
 */
static inline float
mavlink_msg_global_vision_position_estimate_get_pitch(const mavlink_message_t *msg) {
 ...
 */
static inline float
mavlink_msg_global_vision_position_estimate_get_yaw(const mavlink_message_t *msg) {
 ...
 */
static inline uint16_t
mavlink_msg_global_vision_position_estimate_get_covariance(const mavlink_message_t *msg,
                                                           float *covariance) {
 ...
 */
static inline void mavlink_msg_global_vision_position_estimate_decode(const mavlink_message_t *msg,
...
#else
    uint8_t len = msg->len < MAVLINK_MSG_ID_GLOBAL_VISION_POSITION_ESTIMATE_LEN ? msg->len
                                                                                : MAVLINK_MSG_ID_GLOBAL_VISION_POSITION_ESTIMATE_LEN;
