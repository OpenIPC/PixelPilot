...
mavlink_msg_component_metadata_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t *msg,
    ...
    return mavlink_finalize_message(msg, system_id, component_id,
                                    MAVLINK_MSG_ID_COMPONENT_METADATA_MIN_LEN,
                                    MAVLINK_MSG_ID_COMPONENT_METADATA_LEN,
                                    MAVLINK_MSG_ID_COMPONENT_METADATA_CRC);
}
 ...
 */
static inline uint16_t
mavlink_msg_component_metadata_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
                                         mavlink_message_t *msg,
                                         uint32_t time_boot_ms, uint32_t file_crc,
                                         const char *uri) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_COMPONENT_METADATA_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
 ...
 */
static inline uint16_t
mavlink_msg_component_metadata_encode(uint8_t system_id, uint8_t component_id,
                                      mavlink_message_t *msg,
                                      const mavlink_component_metadata_t *component_metadata) {
    return mavlink_msg_component_metadata_pack(system_id, component_id, msg,
                                               component_metadata->time_boot_ms,
                                               component_metadata->file_crc,
                                               component_metadata->uri);
}
 ...
 */
static inline uint16_t
mavlink_msg_component_metadata_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
                                           mavlink_message_t *msg,
                                           const mavlink_component_metadata_t *component_metadata) {
    return mavlink_msg_component_metadata_pack_chan(system_id, component_id, chan, msg,
                                                    component_metadata->time_boot_ms,
                                                    component_metadata->file_crc,
                                                    component_metadata->uri);
}
...
mavlink_msg_component_metadata_get_time_boot_ms(const mavlink_message_t *msg) {
 ...
 */
static inline uint16_t
mavlink_msg_component_metadata_get_uri(const mavlink_message_t *msg, char *uri) {
 ...
 */
static inline void mavlink_msg_component_metadata_decode(const mavlink_message_t *msg,
