...
mavlink_msg_play_tune_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t *msg,
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_PLAY_TUNE_MIN_LEN,
 ...
 */
static inline uint16_t
mavlink_msg_play_tune_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
    ...
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan,
                                         MAVLINK_MSG_ID_PLAY_TUNE_MIN_LEN,
                                         MAVLINK_MSG_ID_PLAY_TUNE_LEN,
 ...
 */
static inline uint16_t
mavlink_msg_play_tune_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t *msg,
                             const mavlink_play_tune_t *play_tune) {
    return mavlink_msg_play_tune_pack(system_id, component_id, msg, play_tune->target_system,
                                      play_tune->target_component, play_tune->tune,
                                      play_tune->tune2);
}
 ...
 */
static inline uint16_t
mavlink_msg_play_tune_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
                                  mavlink_message_t *msg, const mavlink_play_tune_t *play_tune) {
    return mavlink_msg_play_tune_pack_chan(system_id, component_id, chan, msg,
                                           play_tune->target_system, play_tune->target_component,
                                           play_tune->tune, play_tune->tune2);
}
 ...
 */
static inline void
mavlink_msg_play_tune_decode(const mavlink_message_t *msg, mavlink_play_tune_t *play_tune) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
