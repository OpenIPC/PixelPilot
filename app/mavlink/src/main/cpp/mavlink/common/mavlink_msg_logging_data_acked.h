...
mavlink_msg_logging_data_acked_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t *msg,
                                    uint8_t target_system, uint8_t target_component,
                                    uint16_t sequence, uint8_t length, uint8_t first_message_offset,
                                    const uint8_t *data) {
    ...
    return mavlink_finalize_message(msg, system_id, component_id,
                                    MAVLINK_MSG_ID_LOGGING_DATA_ACKED_MIN_LEN,
 ...
 */
static inline uint16_t
mavlink_msg_logging_data_acked_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
                                         mavlink_message_t *msg,
                                         uint8_t target_system, uint8_t target_component,
                                         uint16_t sequence, uint8_t length,
                                         uint8_t first_message_offset, const uint8_t *data) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_LOGGING_DATA_ACKED_LEN];
    _mav_put_uint16_t(buf, 0, sequence);
    _mav_put_uint8_t(buf, 2, target_system);
 ...
 */
static inline uint16_t
mavlink_msg_logging_data_acked_encode(uint8_t system_id, uint8_t component_id,
                                      mavlink_message_t *msg,
                                      const mavlink_logging_data_acked_t *logging_data_acked) {
    return mavlink_msg_logging_data_acked_pack(system_id, component_id, msg,
 ...
 */
static inline uint16_t
mavlink_msg_logging_data_acked_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
                                           mavlink_message_t *msg,
                                           const mavlink_logging_data_acked_t *logging_data_acked) {
    return mavlink_msg_logging_data_acked_pack_chan(system_id, component_id, chan, msg,
                                                    logging_data_acked->target_system,
                                                    logging_data_acked->target_component,
                                                    logging_data_acked->sequence,
                                                    logging_data_acked->length,
...
mavlink_msg_logging_data_acked_get_target_system(const mavlink_message_t *msg) {
 ...
 */
static inline uint8_t
mavlink_msg_logging_data_acked_get_target_component(const mavlink_message_t *msg) {
 ...
 */
static inline uint8_t
mavlink_msg_logging_data_acked_get_first_message_offset(const mavlink_message_t *msg) {
 ...
 */
static inline uint16_t
mavlink_msg_logging_data_acked_get_data(const mavlink_message_t *msg, uint8_t *data) {
 ...
 */
static inline void mavlink_msg_logging_data_acked_decode(const mavlink_message_t *msg,
...
#else
    uint8_t len = msg->len < MAVLINK_MSG_ID_LOGGING_DATA_ACKED_LEN ? msg->len
                                                                   : MAVLINK_MSG_ID_LOGGING_DATA_ACKED_LEN;
