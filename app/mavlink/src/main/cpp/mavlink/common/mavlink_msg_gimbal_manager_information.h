...
mavlink_msg_gimbal_manager_information_pack(uint8_t system_id, uint8_t component_id,
                                            mavlink_message_t *msg,
                                            uint32_t time_boot_ms, uint32_t cap_flags,
                                            uint8_t gimbal_device_id, float roll_min,
 ...
 */
static inline uint16_t
mavlink_msg_gimbal_manager_information_pack_chan(uint8_t system_id, uint8_t component_id,
                                                 uint8_t chan,
                                                 mavlink_message_t *msg,
                                                 uint32_t time_boot_ms, uint32_t cap_flags,
                                                 uint8_t gimbal_device_id, float roll_min,
 ...
 */
static inline uint16_t
mavlink_msg_gimbal_manager_information_encode(uint8_t system_id, uint8_t component_id,
                                              mavlink_message_t *msg,
                                              const mavlink_gimbal_manager_information_t *gimbal_manager_information) {
    return mavlink_msg_gimbal_manager_information_pack(system_id, component_id, msg,
                                                       gimbal_manager_information->time_boot_ms,
                                                       gimbal_manager_information->cap_flags,
                                                       gimbal_manager_information->gimbal_device_id,
                                                       gimbal_manager_information->roll_min,
                                                       gimbal_manager_information->roll_max,
                                                       gimbal_manager_information->pitch_min,
                                                       gimbal_manager_information->pitch_max,
                                                       gimbal_manager_information->yaw_min,
                                                       gimbal_manager_information->yaw_max);
}
 ...
 */
static inline uint16_t
mavlink_msg_gimbal_manager_information_encode_chan(uint8_t system_id, uint8_t component_id,
                                                   uint8_t chan, mavlink_message_t *msg,
                                                   const mavlink_gimbal_manager_information_t *gimbal_manager_information) {
    return mavlink_msg_gimbal_manager_information_pack_chan(system_id, component_id, chan, msg,
                                                            gimbal_manager_information->time_boot_ms,
                                                            gimbal_manager_information->cap_flags,
                                                            gimbal_manager_information->gimbal_device_id,
                                                            gimbal_manager_information->roll_min,
...
mavlink_msg_gimbal_manager_information_get_time_boot_ms(const mavlink_message_t *msg) {
 ...
 */
static inline uint32_t
mavlink_msg_gimbal_manager_information_get_cap_flags(const mavlink_message_t *msg) {
...
mavlink_msg_gimbal_manager_information_get_gimbal_device_id(const mavlink_message_t *msg) {
 ...
 */
static inline float
mavlink_msg_gimbal_manager_information_get_roll_min(const mavlink_message_t *msg) {
 ...
 */
static inline float
mavlink_msg_gimbal_manager_information_get_roll_max(const mavlink_message_t *msg) {
 ...
 */
static inline float
mavlink_msg_gimbal_manager_information_get_pitch_min(const mavlink_message_t *msg) {
 ...
 */
static inline float
mavlink_msg_gimbal_manager_information_get_pitch_max(const mavlink_message_t *msg) {
 ...
 */
static inline float
mavlink_msg_gimbal_manager_information_get_yaw_min(const mavlink_message_t *msg) {
 ...
 */
static inline float
mavlink_msg_gimbal_manager_information_get_yaw_max(const mavlink_message_t *msg) {
 ...
 */
static inline void mavlink_msg_gimbal_manager_information_decode(const mavlink_message_t *msg,
                                                                 mavlink_gimbal_manager_information_t *gimbal_manager_information) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    gimbal_manager_information->time_boot_ms = mavlink_msg_gimbal_manager_information_get_time_boot_ms(
            msg);
    gimbal_manager_information->cap_flags = mavlink_msg_gimbal_manager_information_get_cap_flags(
            msg);
    ...
    gimbal_manager_information->pitch_min = mavlink_msg_gimbal_manager_information_get_pitch_min(
            msg);
    gimbal_manager_information->pitch_max = mavlink_msg_gimbal_manager_information_get_pitch_max(
            msg);
    ...
    gimbal_manager_information->gimbal_device_id = mavlink_msg_gimbal_manager_information_get_gimbal_device_id(
            msg);
#else
