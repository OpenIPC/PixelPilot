...
mavlink_msg_esc_telemetry_1_to_4_pack(uint8_t system_id, uint8_t component_id,
 ...
 */
static inline uint16_t
mavlink_msg_esc_telemetry_1_to_4_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
                                           mavlink_message_t *msg,
                                           const uint8_t *temperature, const uint16_t *voltage,
                                           const uint16_t *current, const uint16_t *totalcurrent,
                                           const uint16_t *rpm, const uint16_t *count) {
 ...
 */
static inline uint16_t
mavlink_msg_esc_telemetry_1_to_4_encode(uint8_t system_id, uint8_t component_id,
                                        mavlink_message_t *msg,
                                        const mavlink_esc_telemetry_1_to_4_t *esc_telemetry_1_to_4) {
    return mavlink_msg_esc_telemetry_1_to_4_pack(system_id, component_id, msg,
                                                 esc_telemetry_1_to_4->temperature,
                                                 esc_telemetry_1_to_4->voltage,
                                                 esc_telemetry_1_to_4->current,
                                                 esc_telemetry_1_to_4->totalcurrent,
                                                 esc_telemetry_1_to_4->rpm,
                                                 esc_telemetry_1_to_4->count);
}
 ...
 */
static inline uint16_t
mavlink_msg_esc_telemetry_1_to_4_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
                                             mavlink_message_t *msg,
                                             const mavlink_esc_telemetry_1_to_4_t *esc_telemetry_1_to_4) {
    return mavlink_msg_esc_telemetry_1_to_4_pack_chan(system_id, component_id, chan, msg,
                                                      esc_telemetry_1_to_4->temperature,
                                                      esc_telemetry_1_to_4->voltage,
                                                      esc_telemetry_1_to_4->current,
                                                      esc_telemetry_1_to_4->totalcurrent,
 ...
 */
static inline uint16_t
mavlink_msg_esc_telemetry_1_to_4_get_temperature(const mavlink_message_t *msg,
                                                 uint8_t *temperature) {
 ...
 */
static inline uint16_t
mavlink_msg_esc_telemetry_1_to_4_get_voltage(const mavlink_message_t *msg, uint16_t *voltage) {
 ...
 */
static inline uint16_t
mavlink_msg_esc_telemetry_1_to_4_get_current(const mavlink_message_t *msg, uint16_t *current) {
 ...
 */
static inline uint16_t
mavlink_msg_esc_telemetry_1_to_4_get_totalcurrent(const mavlink_message_t *msg,
 ...
 */
static inline uint16_t
mavlink_msg_esc_telemetry_1_to_4_get_rpm(const mavlink_message_t *msg, uint16_t *rpm) {
 ...
 */
static inline uint16_t
mavlink_msg_esc_telemetry_1_to_4_get_count(const mavlink_message_t *msg, uint16_t *count) {
 ...
 */
static inline void mavlink_msg_esc_telemetry_1_to_4_decode(const mavlink_message_t *msg,
                                                           mavlink_esc_telemetry_1_to_4_t *esc_telemetry_1_to_4) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
