...
static void mavlink_test_icarous_heartbeat(uint8_t system_id, uint8_t component_id,
    ...
    memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_icarous_heartbeat_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg,
                                            packet1.status);
    mavlink_msg_icarous_heartbeat_decode(&msg, &packet2);
    MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_icarous_kinematic_bands(uint8_t system_id, uint8_t component_id,
                                                 mavlink_message_t *last_msg) {
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
    ...
    mavlink_icarous_kinematic_bands_t packet_in = {
            17.0, 45.0, 73.0, 101.0, 129.0, 157.0, 185.0, 213.0, 241.0, 269.0, 125, 192, 3, 70, 137,
            204
    };
    ...
    memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_icarous_kinematic_bands_pack(system_id, component_id, &msg, packet1.numBands,
                                             packet1.type1, packet1.min1, packet1.max1,
                                             packet1.type2, packet1.min2, packet1.max2,
                                             packet1.type3, packet1.min3, packet1.max3,
                                             packet1.type4, packet1.min4, packet1.max4,
                                             packet1.type5, packet1.min5, packet1.max5);
    mavlink_msg_icarous_kinematic_bands_decode(&msg, &packet2);
    MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

    memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_icarous_kinematic_bands_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg,
                                                  packet1.numBands, packet1.type1, packet1.min1,
                                                  packet1.max1, packet1.type2, packet1.min2,
                                                  packet1.max2, packet1.type3, packet1.min3,
                                                  packet1.max3, packet1.type4, packet1.min4,
                                                  packet1.max4, packet1.type5, packet1.min5,
                                                  packet1.max5);
    mavlink_msg_icarous_kinematic_bands_decode(&msg, &packet2);
    MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_icarous_kinematic_bands_send(MAVLINK_COMM_1, packet1.numBands, packet1.type1,
                                             packet1.min1, packet1.max1, packet1.type2,
                                             packet1.min2, packet1.max2, packet1.type3,
                                             packet1.min3, packet1.max3, packet1.type4,
                                             packet1.min4, packet1.max4, packet1.type5,
                                             packet1.min5, packet1.max5);
    mavlink_msg_icarous_kinematic_bands_decode(last_msg, &packet2);
    MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void
mavlink_test_icarous(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg) {
