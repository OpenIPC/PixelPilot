...
mavlink_msg_set_mag_offsets_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t *msg,
                                 uint8_t target_system, uint8_t target_component, int16_t mag_ofs_x,
                                 int16_t mag_ofs_y, int16_t mag_ofs_z) {
    ...
    return mavlink_finalize_message(msg, system_id, component_id,
                                    ...
                                    MAVLINK_MSG_ID_SET_MAG_OFFSETS_LEN,
                                    MAVLINK_MSG_ID_SET_MAG_OFFSETS_CRC);
}
 ...
 */
static inline uint16_t
mavlink_msg_set_mag_offsets_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static inline uint16_t
mavlink_msg_set_mag_offsets_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t *msg,
                                   const mavlink_set_mag_offsets_t *set_mag_offsets) {
    return mavlink_msg_set_mag_offsets_pack(system_id, component_id, msg,
                                            set_mag_offsets->target_system,
                                            set_mag_offsets->target_component,
                                            set_mag_offsets->mag_ofs_x, set_mag_offsets->mag_ofs_y,
 ...
 */
static inline uint16_t
mavlink_msg_set_mag_offsets_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
                                        mavlink_message_t *msg,
                                        const mavlink_set_mag_offsets_t *set_mag_offsets) {
    return mavlink_msg_set_mag_offsets_pack_chan(system_id, component_id, chan, msg,
                                                 set_mag_offsets->target_system,
                                                 set_mag_offsets->target_component,
...
mavlink_msg_set_mag_offsets_get_target_component(const mavlink_message_t *msg) {
 ...
 */
static inline void mavlink_msg_set_mag_offsets_decode(const mavlink_message_t *msg,
