...
mavlink_msg_message_interval_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t *msg,
    ...
    return mavlink_finalize_message(msg, system_id, component_id,
                                    ...
                                    MAVLINK_MSG_ID_MESSAGE_INTERVAL_CRC);
}
 ...
 */
static inline uint16_t
mavlink_msg_message_interval_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static inline uint16_t
mavlink_msg_message_interval_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t *msg,
                                    const mavlink_message_interval_t *message_interval) {
    return mavlink_msg_message_interval_pack(system_id, component_id, msg,
                                             message_interval->message_id,
                                             message_interval->interval_us);
}
 ...
 */
static inline uint16_t
mavlink_msg_message_interval_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
                                         mavlink_message_t *msg,
                                         const mavlink_message_interval_t *message_interval) {
    return mavlink_msg_message_interval_pack_chan(system_id, component_id, chan, msg,
                                                  message_interval->message_id,
                                                  message_interval->interval_us);
}
 ...
 */
static inline void mavlink_msg_message_interval_decode(const mavlink_message_t *msg,
...
#else
    uint8_t len = msg->len < MAVLINK_MSG_ID_MESSAGE_INTERVAL_LEN ? msg->len
                                                                 : MAVLINK_MSG_ID_MESSAGE_INTERVAL_LEN;
