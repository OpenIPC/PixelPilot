...
mavlink_msg_param_ext_request_read_pack(uint8_t system_id, uint8_t component_id,
 ...
 */
static inline uint16_t
mavlink_msg_param_ext_request_read_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
                                             mavlink_message_t *msg,
                                             uint8_t target_system, uint8_t target_component,
                                             const char *param_id, int16_t param_index) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint16_t
mavlink_msg_param_ext_request_read_encode(uint8_t system_id, uint8_t component_id,
                                          mavlink_message_t *msg,
                                          const mavlink_param_ext_request_read_t *param_ext_request_read) {
    return mavlink_msg_param_ext_request_read_pack(system_id, component_id, msg,
 ...
 */
static inline uint16_t
mavlink_msg_param_ext_request_read_encode_chan(uint8_t system_id, uint8_t component_id,
                                               uint8_t chan, mavlink_message_t *msg,
                                               const mavlink_param_ext_request_read_t *param_ext_request_read) {
    return mavlink_msg_param_ext_request_read_pack_chan(system_id, component_id, chan, msg,
                                                        param_ext_request_read->target_system,
                                                        param_ext_request_read->target_component,
                                                        param_ext_request_read->param_id,
                                                        param_ext_request_read->param_index);
...
mavlink_msg_param_ext_request_read_get_target_system(const mavlink_message_t *msg) {
 ...
 */
static inline uint8_t
mavlink_msg_param_ext_request_read_get_target_component(const mavlink_message_t *msg) {
 ...
 */
static inline uint16_t
mavlink_msg_param_ext_request_read_get_param_id(const mavlink_message_t *msg, char *param_id) {
...
mavlink_msg_param_ext_request_read_get_param_index(const mavlink_message_t *msg) {
...
#else
    uint8_t len = msg->len < MAVLINK_MSG_ID_PARAM_EXT_REQUEST_READ_LEN ? msg->len
                                                                       : MAVLINK_MSG_ID_PARAM_EXT_REQUEST_READ_LEN;
