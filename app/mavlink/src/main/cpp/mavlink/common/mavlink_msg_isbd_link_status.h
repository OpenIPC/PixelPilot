...
mavlink_msg_isbd_link_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t *msg,
                                  uint64_t timestamp, uint64_t last_heartbeat,
                                  uint16_t failed_sessions, uint16_t successful_sessions,
                                  uint8_t signal_quality, uint8_t ring_pending,
 ...
 */
static inline uint16_t
mavlink_msg_isbd_link_status_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static inline uint16_t
mavlink_msg_isbd_link_status_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t *msg,
                                    const mavlink_isbd_link_status_t *isbd_link_status) {
    return mavlink_msg_isbd_link_status_pack(system_id, component_id, msg,
                                             isbd_link_status->timestamp,
                                             isbd_link_status->last_heartbeat,
                                             isbd_link_status->failed_sessions,
                                             isbd_link_status->successful_sessions,
                                             isbd_link_status->signal_quality,
                                             isbd_link_status->ring_pending,
                                             isbd_link_status->tx_session_pending,
 ...
 */
static inline uint16_t
mavlink_msg_isbd_link_status_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
                                         mavlink_message_t *msg,
                                         const mavlink_isbd_link_status_t *isbd_link_status) {
    return mavlink_msg_isbd_link_status_pack_chan(system_id, component_id, chan, msg,
                                                  isbd_link_status->timestamp,
                                                  isbd_link_status->last_heartbeat,
                                                  isbd_link_status->failed_sessions,
                                                  isbd_link_status->successful_sessions,
...
mavlink_msg_isbd_link_status_get_last_heartbeat(const mavlink_message_t *msg) {
 ...
 */
static inline uint16_t
mavlink_msg_isbd_link_status_get_failed_sessions(const mavlink_message_t *msg) {
 ...
 */
static inline uint16_t
mavlink_msg_isbd_link_status_get_successful_sessions(const mavlink_message_t *msg) {
...
mavlink_msg_isbd_link_status_get_signal_quality(const mavlink_message_t *msg) {
 ...
 */
static inline uint8_t
mavlink_msg_isbd_link_status_get_tx_session_pending(const mavlink_message_t *msg) {
 ...
 */
static inline uint8_t
mavlink_msg_isbd_link_status_get_rx_session_pending(const mavlink_message_t *msg) {
 ...
 */
static inline void mavlink_msg_isbd_link_status_decode(const mavlink_message_t *msg,
                                                       mavlink_isbd_link_status_t *isbd_link_status) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    ...
    isbd_link_status->successful_sessions = mavlink_msg_isbd_link_status_get_successful_sessions(
            msg);
